...
public class FindExcHandlerWithTreeStrategyTests
{
    ...
    public void ReturnKeyValueHandlerTreeDictTest()
    {
        ...
        IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Game.Exception.GetSubTree", (object[] args) => (object) null!).Execute();
        ...
        // Act
        // Assert
        Assert.NotNull(FindExcHandlerStrategy.Execute(new object[] {new Mock<ICommand>().Object, new Mock<Exception>().Object}));
    }
    ...
    public void ReturnKeyValueSubTreeDictTest()
    {
        ...
        var SubDict = new Mock<IReadOnlyDictionary<Int32, IStrategy>>();
        SubDict.Setup(htd => htd.TryGetValue(It.IsAny<Int32>(), out Handler)).Returns(true);
    ...
    public void ExceptionHandlerWasntFoundTest()
    {
        ...
        // Act
        // Assert
        Assert.Null(FindExcHandlerStrategy.Execute(new object[] {new Mock<ICommand>().Object, new Mock<Exception>().Object}));
    }
}
